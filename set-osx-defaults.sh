...
sudo scutil --set ComputerName "Murats MacMini"
sudo scutil --set HostName "Murats MacMini"
sudo scutil --set LocalHostName "Murats-MacMini"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Murats-MacMini"
